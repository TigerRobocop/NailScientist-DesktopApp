...
public class GUI_finish_update extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            altFinish.setName((jTextFieldTipoFinalizacao.getText()));
...
//            new GUI_Finish().setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_finish_update.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
